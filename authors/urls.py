...
author_api_router.register('api', views.AuthorsViewSet, basename='author-api')
...
urlpatterns = [
    ...
    path('dashboard/recipe/<int:id>/', views.DashboardRecipe.as_view(), name='dashboard_recipe_edit'),
